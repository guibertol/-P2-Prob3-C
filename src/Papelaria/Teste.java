...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        pedido.setTipoDeEntrega(Pedido.TipoDeEntrega.EncomendaPAC);

        mensagens(pedido);

        pedido.setTipoDeEntrega(Pedido.TipoDeEntrega.Sedex);
        
        mensagens(pedido);
        
        pedido.setTipoDeEntrega(Pedido.TipoDeEntrega.RetiradaNoLocal);
